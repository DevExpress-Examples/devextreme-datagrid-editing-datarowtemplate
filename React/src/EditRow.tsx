...
import type { ColumnNames, RowTemplateData } from './utils';
...
function EditRow({ rowInfo }: { rowInfo: RowTemplateData<Employee, number> }): JSX.Element {
  ...
  return (
    <React.Fragment>
      ...
      <tr className="notes-row">
        <td colSpan={6}>
          <TextArea defaultValue={rowInfo.data.Notes} onValueChanged={valueChangeAction('Notes', rowInfo.data.ID)} />
        </td>
      </tr>
    </React.Fragment>
  );
